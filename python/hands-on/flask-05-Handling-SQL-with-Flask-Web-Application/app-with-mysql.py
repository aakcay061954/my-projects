...
app.config['MYSQL_DATABASE_HOST'] = 'abdullah-database.cdpqhims3kaf.us-east-1.rds.amazonaws.com'
...
VALUES 
	("Abdullah", "abdullah@amazon.com" ),
	("Furkan", "furkan@micrasoft.com"),
	("Funda", "funda@facebook.com"),
    ("sait", "sait@tesla.com"),
    ("busra","busra@google");
"""
